...
mode="['gnn_default','gnn_xyz','gnn_4extra_xyz','gnn_4extra_noxyz','None'][0]"
model_variant=AttentiveFP
epochs=300
batch_size=32
lr=0.0001
activ_str="nn.GELU()"
lr_cyc_start=125
add_residual="False"
gnn_cfg="{'gnn_in_channels': 48,         'gnn_hidden_channels': 512,         'gnn_out_channels': 1,         'gnn_num_layers': 4,         'gnn_num_timesteps': 4,         'gnn_edge_dim': 10,         'gnn_dropout':0.2,         'gnn_activation':nn.GELU()}"
gnn_dense_cfg="None"
...
python net_cfg_save.py "${python_arguments[@]}"
